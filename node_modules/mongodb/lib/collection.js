 ...
 * @param {boolean} [options.partials=false] Specify if the cursor should return partials results when querying against a sharded system
 ...
 * @param {object} [options.partialFilterExpression=null] Creates a partials index based on the given filter object (MongoDB 3.2 or higher)
 * @param {object} [options.collation=null] Specify collation (MongoDB 3.4 or higher) settings for update operation (see 3.4 documentation for available fields).
 * @param {ClientSession} [options.session] optional session to use for this operation
 * @param {Collection~resultCallback} [callback] The command result callback
 * @return {Promise} returns Promise if no callback passed
