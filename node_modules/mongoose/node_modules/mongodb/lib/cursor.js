 ...
 * collection.find({}).addCursorFlag('partials', true)             // Set cursor as partials
 ...
 * @method
 * @param {string} flag The flag to set, must be one of following ['tailable', 'oplogReplay', 'noCursorTimeout', 'awaitData', 'partials'].
 ...
 * is enough memory to store the results. Note that the array only contain partials
