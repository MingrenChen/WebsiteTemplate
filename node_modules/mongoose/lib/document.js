 ...
 * ####Note:
 *
 * This getter exists on all documents by default. The getter can be disabled by setting the `id` [option](/docs/guide.view#id) of its `Schema` to false at construction time.
 *
 *     new Schema({ name: String }, { id: false });
 *
 * @api public
 * @see Schema options /docs/guide.view#options
 * @property id
 * @memberOf Document
 */
 ...
 *
 * _Very helpful when using [Mixed](./schematypes.view#mixed) types._
 *
 * ####Example:
 *
 ...
 *
 * See [schema options](/docs/guide.view#toObject) for some more details.
 *
 ...
 *
 * See [schema options](/docs/guide.view#toJSON) for details.
 *
 * @param {Object} options
 * @return {Object}
