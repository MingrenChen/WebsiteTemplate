...
;(function() {
  ...
  function runInContext(context) {
     ...
     * `modArgs`, `negate`, `omit`, `once`, `pairs`, `partials`, `partialRight`,
     ...
     * @param {boolean} [isLoose] Specify performing partials comparisons.
    ...
    /**
     * Creates a `_.partials` or `_.partialRight` function.
     *
     * @private
     * @param {boolean} flag The partials bit flag.
     * @returns {Function} Returns the new partials function.
     */
     ...
     * binding of, partials application, and currying.
     *
     * @private
    ...
    /**
     * Creates a function that invokes `func` with `partials` arguments prepended
     ...
     * @example
     *
     * var diceRolls = _.times(3, _.partials(_.random, 1, 6, false));
     * // => [3, 6, 4]
     *
